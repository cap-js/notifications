...
describe("Managing of Notification Types", () => {
  ...
  describe("Create Notification Types Map", () => {
    it("Seed the Default type when isLocal is true", () => {
    ...
    it("Store multiple versions of the same type under the same key", () => {
  ...
  describe("Process Notification Types", () => {
    ...
    describe("Creating Types", () => {
      ...
      it("Do not create Default type when it already exists in Work Zone", () => {
      ...
      it("Create a missing version when another version of the same type exists", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Fall back gracefully when create response has no data.d", () => {
      ...
      it("Create new types correctly when existing types use OData results format", () => {
    ...
    describe("Updating Types", () => {
      ...
      it("Update type when an additional Template is added", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Update type when an additional Action is added", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Update type when an additional DeliveryChannel is added", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Update type when any individual field has changed", async () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Update type when existing type has null inner results", () => {
        httpClient.executeHttpRequest.mockReturnValue({
          data: {
            d: {
              results: [{
    ...
    describe("No Changed Needed", () => {
      it("Do nothing when all types match exactly", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Do nothing when input Templates/Actions/DeliveryChannels use OData results wrapper", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Do nothing when IsGroupable is undefined (treated as true)", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Do nothing when Language fields are lowercase", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Do nothing when TemplateLanguage is lowercase", () => {
        httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
      ...
      it("Do nothing when Templates, Actions and DeliveryChannels are null in both local and remote", () => {
      ...
      it("Do nothing when existing type matches local type exactly", () => {
        httpClient.executeHttpRequest.mockReturnValue({
          data: {
            d: {
              results: [
    ...
    it("Deletes a type that is no longer in the local file", () => {
      httpClient.executeHttpRequest.mockReturnValue(allExistingResponseBody);
