...
describe("Notifications Integration", () => {
  ...
  test("before('*') hook is called before a notification is sent and receives msg.event and msg.data", async () => {
  ...
  test("before('*') hook can suppress a notification by throwing", async () => {
