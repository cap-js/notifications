...
const supportedANSLanguages = {AF, AR, BG, CA, ZH, ZF, HR, CS, DA, NL, EN, ET, FI, FR, KM, DE, EL, HE, HU, IS, ID, IT, HI, JA, KO, LV, LT, MS, NO, NB, PL, PT, Z1, RO, RU, SR, SH, SK, VI, SL, ES, SV, TH, TR, UK, IW, IN, ZH_HANS, ZH_HANT, ZH_CN, ZH_TW}

const sanitizedLocale = () => supportedANSLanguages[cds.context.locale] != undefined ? cds.context.locale : 'en'
