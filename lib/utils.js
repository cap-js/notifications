...
function buildCustomNotification(notificationData) {
  // REVISIT: Why not just returning notificationData.payload?
  ...
  return {
    ...
    NotificationTypeVersion: payload.NotificationTypeVersion || "1",
    NavigationTargetAction: navigation.NavigationTargetAction,
    NavigationTargetObject: navigation.NavigationTargetObject,
    Priority: notificationData.priority || "NEUTRAL",
    ProviderId: payload.ProviderId,
    ActorId: payload.ActorId,
    ActorDisplayText: payload.ActorDisplayText,
    ActorImageURL: payload.ActorImageURL,
    NotificationTypeTimestamp: payload.NotificationTypeTimestamp,
