...
async function createNotificationType(notificationType) {
  ...
  if (!hasTemplate) {
    throw new Error(`Notification type '${notificationType.NotificationTypeKey}' has no template titles. At least one of TemplateSensitive, TemplatePublic, or TemplateGrouped must be provided in the @notification annotation.`)
  }
