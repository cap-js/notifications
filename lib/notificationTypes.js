...
async function createNotificationType(notificationType) {
  ...
  console.log(`Notification Type of key ${notificationType.NotificationTypeKey} and version ${notificationType.NotificationTypeVersion} was not found. Creating it...`);
...
async function updateNotificationType(id, notificationType) {
  ...
  console.log(`Detected change in notification type of key ${notificationType.NotificationTypeKey} and version ${notificationType.NotificationTypeVersion}. Updating it...`);
...
async function deleteNotificationType(notificationType) {
  ...
  console.log(`Notification Type of key ${notificationType.NotificationTypeKey} and version ${notificationType.NotificationTypeVersion} not present in the types file. Deleting it...`);
